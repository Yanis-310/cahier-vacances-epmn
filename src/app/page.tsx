      ...
      <main>
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-24 sm:pt-32 sm:pb-40 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                ...
                className="btn-solar-primary px-8 py-3 rounded-lg text-lg font-medium transition-colors"
              >
                {lastProgress ? "Reprendre les exercices" : "Commencer les exercices"}
              </Link>
              <Link
                href="/evaluation"
                className="btn-solar-outline px-8 py-3 rounded-lg text-lg font-medium transition-colors"
              >
                Mode évaluation
              </Link>
            </div>
        ...
        <section style={{ backgroundColor: "#FCF4E8" }}>
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            ...
            {/* Progress Card */}
            <div className="bg-white rounded-xl p-8 shadow-sm relative overflow-hidden" style={{ border: "1.5px solid #F2C073" }}>
              ...
              <div className="w-full bg-foreground/5 rounded-full h-2">
                <div
                  ...
                  style={{ width: `${progressPercent}%`, backgroundColor: "#F2C073" }}
                />
              </div>
            ...
            <Link
              href={lastProgress ? `/exercises/${lastProgress.exercise.id}` : "/exercises"}
              className="group bg-white rounded-xl p-8 shadow-sm hover:shadow-md transition-shadow cursor-pointer relative overflow-hidden"
